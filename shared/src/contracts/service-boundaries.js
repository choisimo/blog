...
export const SERVICE_BOUNDARIES = Object.freeze([
  ...
  { id: 'admin-ai-images', prefix: '/api/v1/admin/ai-images', owner: ROUTE_OWNERS.BACKEND, description: 'Backend admin AI image generation and storage' },
...
export const ROUTE_BOUNDARIES = Object.freeze([
  ...
  { id: 'admin-logs.list', method: 'GET', path: '/api/v1/admin/logs', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'admin-logs', description: 'Backend admin log history via worker proxy' },
  { id: 'admin-ai-images.generate', method: 'POST', path: '/api/v1/admin/ai-images/generate', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'admin-ai-images', description: 'Backend AI image generation for admin post authoring' },
  { id: 'admin-ai-images.health', method: 'GET', path: '/api/v1/admin/ai-images/health', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'admin-ai-images', description: 'Backend AI image generation configuration health' },
  { id: 'rag.search', method: 'POST', path: '/api/v1/rag/search', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG semantic search via worker proxy' },
  { id: 'rag.embed', method: 'POST', path: '/api/v1/rag/embed', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG embedding generation via worker proxy' },
  { id: 'rag.health', method: 'GET', path: '/api/v1/rag/health', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG health via worker proxy' },
  { id: 'rag.status', method: 'GET', path: '/api/v1/rag/status', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG collection status via worker proxy' },
  { id: 'rag.collections', method: 'GET', path: '/api/v1/rag/collections', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG collection listing via worker proxy' },
  { id: 'rag.index.create', method: 'POST', path: '/api/v1/rag/index', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG document indexing via worker proxy' },
  { id: 'rag.index.delete', method: 'DELETE', path: '/api/v1/rag/index/:documentId', owner: ROUTE_OWNERS.BACKEND, boundaryId: 'rag', description: 'Backend RAG document delete via worker proxy' },
