...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <text x="${w - 64}" y="${h - 48}" text-anchor="end" fill="${fg}" opacity="0.6" font-family="ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Arial" font-size="22">${escapeXml(process.env.VITE_SITE_BASE_URL || process.env.SITE_BASE_URL || '')}</text>
</svg>`;
