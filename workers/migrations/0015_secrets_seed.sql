...
INSERT OR IGNORE INTO secrets (id, category_id, key_name, display_name, description, is_required, is_sensitive, value_type, env_fallback) VALUES
  ...
  ('sec_ai_serve_api_key', 'cat_ai', 'AI_API_KEY', 'AI Serve API Key', 'Internal API key for AI backend server', 0, 1, 'string', 'AI_API_KEY');
...
INSERT OR IGNORE INTO secrets (id, category_id, key_name, display_name, description, is_required, is_sensitive, value_type, env_fallback) VALUES
  ...
  ('sec_ai_serve_base_url', 'cat_general', 'AI_SERVER_URL', 'AI Serve Base URL', 'URL for AI backend server', 0, 0, 'url', 'AI_SERVER_URL');
