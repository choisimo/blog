...
def main() -> None:
    ...
    tei_model_name = os.environ.get('TEI_MODEL_NAME', 'all-MiniLM-L6-v2').strip() or 'all-MiniLM-L6-v2'
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as ex:
        ...
        for fut in as_completed(futures):
            try:
                ...
                # best effort: continue processing other docs
                continue
