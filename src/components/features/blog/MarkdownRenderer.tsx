        ...
        components={{
          h1: ({ children }) => {
            ...
            return (
              <h1
                id={id}
                className='text-4xl font-bold mt-12 mb-6 scroll-mt-24 text-center max-w-4xl mx-auto'
              >
                {children}
              </h1>
            );
          ...
          h2: ({ children }) => {
            ...
            return (
              <h2
                id={id}
                className='text-3xl font-semibold mt-10 mb-5 scroll-mt-24 text-center max-w-4xl mx-auto'
              >
                {children}
              </h2>
            );
          ...
          h3: ({ children }) => {
            ...
            return (
              <h3
                id={id}
                className='text-2xl font-semibold mt-8 mb-4 scroll-mt-24 text-center max-w-4xl mx-auto'
              >
                {children}
              </h3>
            );
          ...
          table: ({ children }) => (
            <div className='overflow-x-auto my-8 max-w-4xl mx-auto'>
              <table className='min-w-full divide-y divide-border rounded-lg shadow-sm'>
                {children}
              </table>
            </div>
          ),
