    ...
    <div className={`prose prose-neutral dark:prose-invert max-w-none prose-lg ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          p: ({ children }) => (
            <p className="mb-6 leading-8 text-justify max-w-4xl mx-auto">{children}</p>
          ),
          ul: ({ children }) => (
            <ul className="list-disc pl-6 mb-6 space-y-3 max-w-4xl mx-auto">{children}</ul>
          ),
          ol: ({ children }) => (
            <ol className="list-decimal pl-6 mb-6 space-y-3 max-w-4xl mx-auto">{children}</ol>
          ),
          li: ({ children }) => (
