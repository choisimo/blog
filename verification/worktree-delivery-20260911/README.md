...
The targeted follow-up passed 17 of 18 cases; its remaining scroll-event race was fixed by awaiting the concealed state, and that case passed on rerun. Six article screenshot artifacts regenerated by the passing cases are included. The final GitHub run remains the authoritative complete browser-suite result.
