...
describe("MarkdownRenderer image paths", () => {
  ...
  it("renders named lightbox controls above a contrast plate", async () => {
    const user = userEvent.setup();
    ...
    expect(controls?.className).toContain("bg-black/60");
    expect(controls?.className).toContain("backdrop-blur");
    expect(
