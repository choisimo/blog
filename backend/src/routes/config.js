    ...
    variables: [
      {
        key: "ASSETS_BASE_URL",
        type: "url",
        description: "Assets Base URL (e.g. https://example.com/images)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        type: "password",
        isSecret: true,
        description: "Embedding API Key (optional)",
      },
      {
        key: "AI_EMBED_MODEL",
        type: "text",
    ...
    variables: [
      {
        ...
        options: ["true", "false"],
        default: "true",
        description: "AI 서비스 활성화",
      },
      {
        key: "FEATURE_RAG_ENABLED",
        type: "select",
        options: ["true", "false"],
        default: "true",
        description: "RAG 검색 활성화",
      },
      {
        key: "FEATURE_TERMINAL_ENABLED",
        type: "select",
        options: ["true", "false"],
        default: "true",
        description: "터미널 서비스 활성화",
      },
      {
        key: "FEATURE_AI_INLINE",
        type: "select",
        options: ["true", "false"],
        default: "true",
        description: "인라인 AI 기능 활성화",
      },
      {
    ...
    variables: [
      {
        ...
        options: ["true", "false"],
        default: "false",
        description: "Consul KV 활성화",
      },
      {
        key: "CONSUL_HOST",
        type: "text",
        default: "consul",
        description: "Consul 호스트",
      },
      {
        key: "CONSUL_PORT",
        type: "number",
        default: "8500",
        description: "Consul 포트",
      },
    ],
  },
];
...
router.post("/save-env", requireAdmin, async (req, res) => {
  ...
  try {
    ...
    res.json({
      ok: true,
      data: { path: envPath, message: "Environment file saved" },
    });
  } catch (err) {
