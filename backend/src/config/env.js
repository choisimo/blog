...
const CONSUL_KEYS = [
  ...
  ['config/features/admin_ai_image_enabled', 'FEATURE_ADMIN_AI_IMAGE_ENABLED'],
  ['services/ai/url', 'AI_SERVER_URL'],
  ['services/ai/image_proxy_base_url', 'AI_IMAGE_PROXY_BASE_URL'],
  ['services/ai/image_proxy_api_key', 'AI_IMAGE_PROXY_API_KEY'],
  ['services/ai/image_model', 'AI_IMAGE_MODEL'],
  ['services/ai/image_timeout_ms', 'AI_IMAGE_TIMEOUT_MS'],
  ['services/ai/image_max_count', 'AI_IMAGE_MAX_COUNT'],
  ['services/ai/image_max_prompt_length', 'AI_IMAGE_MAX_PROMPT_LENGTH'],
  ['services/ai/image_max_output_bytes', 'AI_IMAGE_MAX_OUTPUT_BYTES'],
  ['services/ai/image_storage_subdir', 'AI_IMAGE_STORAGE_SUBDIR'],
