/**
 * Query Expander - LLM-based multilingual query expansion for RAG
 *
...
import { getOpenAIClient } from './openai-compat-client.js';
...
const DEFAULT_MODEL = 'gpt-4.1-mini'; // Use faster model for query expansion
